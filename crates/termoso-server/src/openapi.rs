...
#[openapi(
    ...
    paths(
        ...
        crate::routes::auth::reauth_start,
        crate::routes::auth::reauth_finish,
        crate::routes::start_over::request,
        crate::routes::start_over::confirm,
        crate::routes::start_over::status,
        crate::routes::start_over::cancel,
        crate::routes::start_over::cancel_authenticated,
        crate::routes::start_over::password_start,
        crate::routes::start_over::finish,
        ...
        crate::routes::teams::get_presence,
        crate::audit::list,
